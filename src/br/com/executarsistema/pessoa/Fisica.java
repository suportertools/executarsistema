package br.com.executarsistema.pessoa;

import br.com.executarsistema.utils.DataHoje;
...
public class Fisica implements java.io.Serializable {
    ...
    @Column(name = "dt_foto")
    private Date dtFoto;
    @Column(name = "ds_titulo_eexecutarsistema", length = 20)
    private String tituloEexecutarsistema;
    ...
    public Fisica(int id, Pessoa pessoa, String rg, String carteira, String serie, String sexo, Date dtNascimento, String nacionalidade,
            ...
            String pis, String aposentadoria, String recadastro, String dataFoto, String tituloEexecutarsistema, String tituloSecao, String tituloZona) {
        this.id = id;
        this.pessoa = pessoa;
        this.rg = rg;
        ...
        this.tituloEexecutarsistema = tituloEexecutarsistema;
    ...
    public String getTituloEexecutarsistema() {
        return tituloEexecutarsistema;
    }

    public void setTituloEexecutarsistema(String tituloEexecutarsistema) {
        this.tituloEexecutarsistema = tituloEexecutarsistema;
    }
